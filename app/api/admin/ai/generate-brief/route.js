...
import { buildAiContext, buildAiInsightRow, generateInsightPayload } from "../../_lib/aiBrief";
...
export async function POST(request) {
  ...
  try {
    ...
    return jsonError(error instanceof Error ? error.message : "Could not generate AI brief.");
  }
}
