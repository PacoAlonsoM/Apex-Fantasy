...
const BASE_AVATAR_THEMES = {
  ember: { fill: "linear-gradient(135deg,#f97316,#fb923c)", bg: "rgba(249,115,22,0.18)", border: "rgba(249,115,22,0.3)", text: "#fff" },
  ocean: { fill: "linear-gradient(135deg,#2563eb,#38bdf8)", bg: "rgba(37,99,235,0.18)", border: "rgba(59,130,246,0.3)", text: "#eff6ff" },
  teal: { fill: "linear-gradient(135deg,#0f766e,#2dd4bf)", bg: "rgba(15,118,110,0.18)", border: "rgba(45,212,191,0.28)", text: "#ecfeff" },
  steel: { fill: "linear-gradient(135deg,#334155,#64748b)", bg: "rgba(100,116,139,0.18)", border: "rgba(148,163,184,0.28)", text: "#f8fafc" },
  gold: { fill: "linear-gradient(135deg,#d97706,#facc15)", bg: "rgba(217,119,6,0.18)", border: "rgba(250,204,21,0.28)", text: "#fff7ed" },
  violet: { fill: "linear-gradient(135deg,#7c3aed,#a78bfa)", bg: "rgba(124,58,237,0.18)", border: "rgba(167,139,250,0.3)", text: "#f5f3ff" },
};
